...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20231029174622_ClientAnnotations")]
    partial class ClientAnnotations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 29, 13, 46, 22, 350, DateTimeKind.Local).AddTicks(7440),
                            ServicesId = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2023, 10, 29, 13, 46, 22, 350, DateTimeKind.Local).AddTicks(7491),
                            ServicesId = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 29, 13, 46, 22, 350, DateTimeKind.Local).AddTicks(7496),
                            ServicesId = 5
                        });
                });
